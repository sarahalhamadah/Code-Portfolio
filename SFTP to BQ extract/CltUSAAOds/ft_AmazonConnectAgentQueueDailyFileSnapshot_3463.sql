CREATE OR REPLACE TABLE FUNCTION CltUSAAOds.ft_AmazonConnectAgentQueueDailyFileSnapshot_3463(iStartDate DATETIME, iEndDate DATETIME)
...
Select
	...
	FileLoadAuditId,
	InactiveInd
FROM `CltUSAAOds.AmazonConnect-AgentQueueDaily-FileSnapshot-3463`
