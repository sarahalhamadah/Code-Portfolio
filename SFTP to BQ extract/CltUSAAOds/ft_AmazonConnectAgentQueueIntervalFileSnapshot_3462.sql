CREATE OR REPLACE TABLE FUNCTION CltUSAAOds.ft_AmazonConnectAgentQueueIntervalFileSnapshot_3462(iStartDate DATETIME, iEndDate DATETIME)
AS
SELECT 
	ParentSystemId,
	SystemId,
	...
	FileLoadAuditId,
	InactiveInd
FROM `CltUSAAOds.AmazonConnect-AgentQueueInterval-FileSnapshot-3462`
