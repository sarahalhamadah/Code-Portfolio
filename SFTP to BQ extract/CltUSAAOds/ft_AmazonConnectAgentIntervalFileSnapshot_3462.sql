CREATE OR REPLACE TABLE FUNCTION CltUSAAOds.ft_AmazonConnectAgentIntervalFileSnapshot_3462(iStartDate DATETIME, iEndDate DATETIME)
AS
SELECT 
	ParentSystemId,
	SystemId,
	...
	FileLoadAuditId,
	InactiveInd
FROM `CltUSAAOds.AmazonConnect-AgentInterval-FileSnapshot-3462`
