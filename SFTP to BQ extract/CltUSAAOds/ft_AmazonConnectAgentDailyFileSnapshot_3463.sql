CREATE OR REPLACE TABLE FUNCTION CltUSAAOds.ft_AmazonConnectAgentDailyFileSnapshot_3463(iStartDate DATETIME, iEndDate DATETIME)
...
SELECT 
	...
	FileLoadAuditId,
	InactiveInd
FROM `CltUSAAOds.AmazonConnect-AgentDaily-FileSnapshot-3463`
