CREATE OR REPLACE TABLE FUNCTION CltUSAAOds.ft_AmazonConnectAgentQueueDailyFileSnapshot_3462(iStartDate DATETIME, iEndDate DATETIME)
AS
Select
	ParentSystemId,
	SystemId,
	...
	FileLoadAuditId,
	InactiveInd
FROM `CltUSAAOds.AmazonConnect-AgentQueueDaily-FileSnapshot-3462`
