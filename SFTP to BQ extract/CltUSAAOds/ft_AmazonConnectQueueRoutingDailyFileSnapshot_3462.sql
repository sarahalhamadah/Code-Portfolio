CREATE OR REPLACE TABLE FUNCTION CltUSAAOds.ft_AmazonConnectQueueRoutingDailyFileSnapshot_3462(iStartDate DATETIME, iEndDate DATETIME)
...
SELECT 
	...
	FileLoadAuditId,
	InactiveInd
FROM `CltUSAAOds.AmazonConnect-QueueRoutingDaily-FileSnapshot-3462`
