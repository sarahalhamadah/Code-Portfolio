CREATE OR REPLACE TABLE FUNCTION CltUSAAOds.ft_AmazonConnectQueueRoutingIntervalFileSnapshot_3463(iStartDate DATETIME, iEndDate DATETIME)
...
SELECT 
	...
	FileLoadAuditId,
	InactiveInd
FROM `CltUSAAOds.AmazonConnect-QueueRoutingInterval-FileSnapshot-3463`
